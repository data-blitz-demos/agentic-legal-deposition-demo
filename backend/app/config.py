...
class Settings(BaseSettings):
    ...
    langfuse_graph_db: str = Field(default="langfusie", alias="LANGFUSE_GRAPH_DB")
    ...
    confident_api_key: str = Field(default="", alias="CONFIDENT_API_KEY")
    langfuse_enabled: bool = Field(default=False, alias="LANGFUSE_ENABLED")
    langfuse_base_url: str = Field(default="", alias="LANGFUSE_BASE_URL")
    langfuse_public_url: str = Field(default="http://localhost:3001", alias="LANGFUSE_PUBLIC_URL")
    langfuse_public_key: str = Field(default="", alias="LANGFUSE_PUBLIC_KEY")
    langfuse_secret_key: str = Field(default="", alias="LANGFUSE_SECRET_KEY")
    langfuse_project_name: str = Field(default="AttorneyOS Demo", alias="LANGFUSE_PROJECT_NAME")
    langfuse_init_user_email: str = Field(default="admin@attorneyos.local", alias="LANGFUSE_INIT_USER_EMAIL")
    langfuse_init_user_name: str = Field(default="AttorneyOS Admin", alias="LANGFUSE_INIT_USER_NAME")
    langfuse_init_user_password: str = Field(default="password123456", alias="LANGFUSE_INIT_USER_PASSWORD")
    langfuse_clickhouse_url: str = Field(default="http://langfuse-clickhouse:8123", alias="LANGFUSE_CLICKHOUSE_URL")
    langfuse_clickhouse_user: str = Field(default="clickhouse", alias="LANGFUSE_CLICKHOUSE_USER")
    langfuse_clickhouse_password: str = Field(default="clickhouse", alias="LANGFUSE_CLICKHOUSE_PASSWORD")
